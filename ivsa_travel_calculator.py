...
st.write("IVSA 임원진 환급 규정(ver.1)에 맞춰 본인의 최종 환급액을 미리 계산해 볼 수 있는 계산기입니다.")
...
with st.form("calculator_form"):
    ...
    fare1 = st.number_input("가는 편 우등 고속버스 기준 요금 (원)", min_value=0, value=13300, step=100)
    ...
    fare2 = st.number_input("오는 편 우등 고속버스 기준 요금 (원)", min_value=0, value=13300, step=100)
